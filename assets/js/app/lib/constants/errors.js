...
const ERROR_LOOK_AT_PARAM_MISSING =
...
const ERROR_TALK_TO_PARAM_MISSING =
...
const ERROR_BREAKTHRU_PARAM_MISSING =
...
const ERROR_USE_WITH_PARAM_INVALID =
  'You cannot use it with <em>that</em>, as <em>that</em> does not exist here or in your inventory.'
...
const ERROR_UNEQUIP_PARAM_MISSING =
  'You cannot just "unequip". You gotta choose something to unequip.'

const ERROR_CHANGE_PARAM_MISSING =
  'You cannot just "change". You gotta choose something to change.<br /><br />Current options are <span class="argument">name</span> and <span class="argument">debug</span>.'
...
const ERROR_DEBUG_STAT_PARAM_MISSING =
...
const ERROR_DEBUG_TELEPORT_PARAMS_MISSING =
  'You cannot just "teleport". You gotta specify an x AND y coordinate, at least.'
const ERROR_DEBUG_TELEPORT_PARAMS_NEEDED =
...
const ERROR_ITEM_REMOVE_INVALID =
