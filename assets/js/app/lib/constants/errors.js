...
const ERROR_CHANGE_PARAM_MISSING            = 'You cannot just "change". You gotta choose something to change.<br /><br />Current options are <span class="argument">name</span> and <span class="argument">debug_mode</span>.'
