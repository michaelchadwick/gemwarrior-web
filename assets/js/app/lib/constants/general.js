...
const GW_COMMANDS = {
  self: ['(c)haracter', '(i)nventory', '(si)t', '(st)and', '(sl)eep'],
  travel: ['(g)o', '(n)orth', '(e)ast', '(s)outh', '(w)est'],
  action: ['(l)ook', '(g)et/(p)ickup/(t)ake', '(d)rop', '(u)se [with/on]'],
  meta: ['(h)elp', '(com)mands', '(hist)ory', '(ab)bout', '(ch)ange'],
  fx: ['(play)bgm', '(stop)bgm'],
}
